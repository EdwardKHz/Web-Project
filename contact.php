...
<head>
    ...
    <meta name="description" content="Contact form for reaching out">
...
<body>
    <div class="layout">
        ...
        <aside class="sidebar" id="sidebar">
            <div class="sidebar-content">
                ...
                <ul>
                    ...
                    <li><a href="#contact-info"><i class="fas fa-info-circle"></i> Contact Info</a></li>
                    <li><a href="#social-media"><i class="fas fa-share-alt"></i> Social Media</a></li>
                </ul>
            </div>
        </aside>
        ...
        <footer>
            <p>&copy; 2025 My Professional Website. All rights reserved.</p>
